...
public class DialogueBd
{
	...
	public static void insertionBD(String mysql) throws PaysServiceException
	{
		Connection cnx = null;
		try
		{
		...
		catch(SQLException e)
		{
			...
			new PaysServiceException(e.getMessage());
		}
	}

	public static List<Object> lecture(String req) throws PaysServiceException
	{
		Connection cnx = null;
		Statement stmt;
		ResultSet rs;
